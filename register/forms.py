...
class CompanyRegistrationForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['name'].widget.attrs['placeholder'] = 'Tên'
        self.fields['email'].widget.attrs['class'] = 'form-control'
        self.fields['email'].widget.attrs['placeholder'] = 'Email'
        self.fields['city'].widget.attrs['class'] = 'form-control'
        self.fields['city'].widget.attrs['placeholder'] = 'Thành phố'
        self.fields['found_date'].widget.attrs['class'] = 'form-control'
        self.fields['found_date'].widget.attrs['placeholder'] = 'Ngày thành lập'
