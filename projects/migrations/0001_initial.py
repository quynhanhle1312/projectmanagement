    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'Chưa hoàn thành'), ('2', 'Đang làm'), ('3', 'Đã hoàn thành')], default=1, max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'Chưa hoàn thành'), ('2', 'Đang làm'), ('3', 'Đã hoàn thành')], default=1, max_length=7)),
                ('due', models.CharField(choices=[('1', 'Chưa hoàn thành'), ('2', 'Đang làm'), ('3', 'Đã hoàn thành')], default=1, max_length=7)),
                ('assign', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
